...
support_comparison %>%
  ...
  labs(title = "Schools in Innovation Networks Receive more Support", subtitle = "A comparison of supports for schools in an innovation network \n to those not a part of an innovation network",
       y = "Percent",
       x = " ",
