...
locale_aov <- aov(bipoc_leader_pct ~ location, data = school_lead_div_gen)
...
suburban_outliers <- school_lead_div_gen %>% filter(school_lead_div_gen$bipoc_leader_pct >= 66 & school_lead_div_gen$location == "Suburban")
suburban_outliers
