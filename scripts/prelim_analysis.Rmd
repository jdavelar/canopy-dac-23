...
ggsave("finding-11-V2.png", plot = locale_plot, path = here("final_products", "draft-findings"),
       width = 12, height = 8, units = "in")
ggsave_transcend(locale_plot, "finding-11-V2")
```
...
ggsave_transcend(level_plot, "finding-1-V3")
```
...
# ggsave_transcend(type_plot2, "finding-2-V3")
```
...
ggsave_transcend(top_prac3, "finding-8b-V3")
```
...
ggsave_transcend(comp_core_funder, "finding-8c-VFunder")
```
