...
#did not repeat = mental health, assessments for deeper learning, multiple opportunities to demonstrate mastery
  ...
  mutate(rank = case_when(
    tag == "practices_pbl" ~ 1,
    tag == "practices_competency_education" ~ 2,
    tag == "practices_culturally_responsive" ~ 3,
    tag == "practices_community_partnerships" ~ 4,
    tag == "practices_sel_integrated" ~ 5,
    tag == "practices_all_courses_designed_for_inclusion" ~ 6,
    tag == "practices_career_prep" ~ 7,
    tag == "practices_restorative" ~ 8,
    tag == "practices_design_marginalized" ~ 9,
...
#PBL, culturally responsive practices, and integrated SEL were in the top 5 for both school-wide practices and core practices
  ...
  theme(legend.position = "bottom",
        legend.direction = "horizontal",
        axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "frequency of top 10 core practices",
       # subtitle = "When Canopy schools select the practices they use, they may select up to 5 practices as 'core practices' central to their learning environment. The comparison below displays differences in selecting any tag compared to selecting that tag as a core practice.",
       x = "",
       y = "") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)),
            size = 5,
