...
# ggsave("finding-9a.png", plot = level_practices_plot, path = here("final_products", "draft-findings"), width = 12, height = 8, units = "in")
```
...
```{r}
locale_plot <- plot_grid(rural_plot, urban_plot, suburban_plot, align = "hv", nrow = 1)
...
# ggsave("finding-9b.png", plot = locale_practices_plot, path = here("final_products", "draft-findings"), width = 15, height = 4, units = "in")
```
...
```{r}
schooltype_plot <- plot_grid(independent_plot, charter_plot, district_plot, align = "hv", nrow = 1)
...
# ggsave("finding-9c.png", plot = schooltyple_practices_plot, path = here("final_products", "draft-findings"), width = 15, height = 4, units = "in")
```
