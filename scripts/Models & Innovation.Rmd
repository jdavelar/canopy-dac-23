...
model %>% 
  ...
  labs(title = "How many schools reported implementing adoptable models?",
       x="") +
  theme_1()
# ggsave("finding-10.png", plot = mod_adopt, path = here("final_products", "draft-findings"),
...
model %>%
  ...
  coord_flip() +
  theme_2()
# ggsave("finding-15.png", plot = pol_locale, path = here("final_products", "draft-findings"),
#        width = 12, height = 8, units = "in")
```
