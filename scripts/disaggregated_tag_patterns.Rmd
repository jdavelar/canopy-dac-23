...
comp_ml
ggsave("finding-19.png", plot = comp_ml, path = here("final_products", "draft-findings"),
       width = 12, height = 8, units = "in")
```
...
ggplot(., aes(reorder(tag, -diff), pct, fill = `Leadership Team`)) + 
  ...
  geom_text(aes(y = .4, label = labs),
            ...
            size = 4)
diff_core
ggsave("finding-17-V2.png", plot = diff_core, path = here("final_products", "draft-findings"),
       width = 12, height = 8, units = "in")
```
